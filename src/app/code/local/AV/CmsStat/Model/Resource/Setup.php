...
class AV_CmsStat_Model_Resource_Setup extends Mage_Catalog_Model_Resource_Setup {

    /**
     *
     * @return AV_CmsStat_Model_Resource_Setup
     */
    ...
    public function addCmsPage($title, $identifier, $content, $is_active = 1, $stores = null) {
        if (is_null($stores)) {
            $stores = array(0);
        } elseif (!is_array($stores)) {
            $stores = array((int) $stores);
